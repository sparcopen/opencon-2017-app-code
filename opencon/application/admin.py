...
from .models import Application2017, Draft, Reference
from .forms import Application2017Form, ChangeStatusAdminForm
...
class Application2017Admin(admin.ModelAdmin):
...
admin.site.register(Application2017, Application2017Admin)
...
class ChangeStatus(Application2017):
    class Meta:
...
class ChangeStatusAdmin(admin.ModelAdmin):
    ...
    def get_queryset(self, request):
        return Application2017.objects.get_all()
