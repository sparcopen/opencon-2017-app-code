...
from .models import Application2017, Airport
...
class Application2017Form(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['gender'] = OptionalChoiceField(
            label=Application2017.GENDER_VERBOSE_NAME,
            help_text=Application2017.GENDER_HELP_TEXT,
            choices=Application2017.GENDER_CHOICES,
        )

        self.fields['ethnicity'] = OptionalMultiChoiceField(
            choices=Application2017.ETHNICITY_CHOICES,
            label=Application2017.ETHNICITY_VERBOSE_NAME,
            help_text=Application2017.ETHNICITY_HELP_TEXT,
        )

        self.fields['airport'] = forms.ModelChoiceField(
            queryset=Airport.objects.all(),
            widget=autocomplete.ModelSelect2(url='application:airport-autocomplete'),
            label=Application2017.AIRPORT_VERBOSE_NAME,
            help_text=Application2017.AIRPORT_HELP_TEXT,
        )
    ...
    class Meta:
        ...
        widgets = {
            ...
            'type': RadioSelect(choices=Application2017.TYPE_CHOICES),
            'events': CheckboxSelectMultiple(choices=Application2017.EVENTS_CHOICES),
            'area_of_interest': RadioSelect(choices=Application2017.AREA_OF_INTEREST_CHOICES),
            'citizenship': Select(choices=Application2017.COUNTRY_CHOICES),
            'residence': Select(choices=Application2017.COUNTRY_CHOICES),
            'profession': CheckboxSelectMultiple(choices=Application2017.PROFESSION_CHOICES),
            'experience': RadioSelect(choices=Application2017.EXPERIENCE_CHOICES),
            'degrees': CheckboxSelectMultiple(choices=Application2017.DEGREES_CHOICES),
            'field': Select(choices=Application2017.FIELD_CHOICES),
            'age': RadioSelect(choices=Application2017.AGE_CHOICES),
            'language_1': Select(choices=Application2017.LANGUAGE_CHOICES),
            'language_2': Select(choices=Application2017.LANGUAGE_CHOICES),
            'language_3': Select(choices=Application2017.LANGUAGE_CHOICES),
            'language_4': Select(choices=Application2017.LANGUAGE_CHOICES),
            'skills': CheckboxSelectMultiple(choices=Application2017.SKILLS_CHOICES),
            'expenses': CheckboxSelectMultiple(choices=Application2017.EXPENSES_CHOICES),
            'fundraising_potential': RadioSelect(choices=Application2017.FUNDRAISING_POTENTIAL_CHOICES),
            'permissions': CheckboxSelectMultiple(choices=Application2017.PERMISSIONS_CHOICES), # to check all choices: `attrs={'checked' : True}`
            'acknowledgments': CheckboxSelectMultiple(choices=Application2017.ACKNOWLEDGMENTS_CHOICES),
        }

    def clean_orcid(self):
        return self.cleaned_data['orcid'].replace('-', '')
